...
class QtCreditCardWidget extends StatefulWidget {
  const QtCreditCardWidget({
    Key key,
  ...
  @override
  _QtCreditCardWidgetState createState() => _QtCreditCardWidgetState();
}

class _QtCreditCardWidgetState extends State<QtCreditCardWidget>
